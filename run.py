        ...
        for dataset_str in datasets:
            ...
            for model_str in models:
                try:
                    ...
                    model.summary()
                    # model_modification_utils.load_weights_by_block_index_list(model, [1, 2, 3, 4, 5, 6, 7, 8, 9],
                    #  os.path.join(
                    # 	global_constant_var.get_experimentcase_abs_path(experiment_name, dataset_str, 'nin_tree_berp_1')
                    # , 'checkpoint'),
