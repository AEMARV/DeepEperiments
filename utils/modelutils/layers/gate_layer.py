...
from utils.modelutils.regularizer.activity_regularizers import VarianceSpatialActivityRegularizer, NormalizeActivityRegularizer
...
def gate_layer(input_tensor, nb_filter, filter_size, opts, input_shape=(None, None, None), border_mode='valid',
	...
	if get_stoc(opts):
		# Stoch tanh
		# gate_output = activations(activation=gate_activation)(data_conv)
