...
# parser.add_argument('model', metavar='model', type=str, help='The model, either vgg16 or resnet50')
...
# parser.add_argument('layer', metavar='layer', type=str, nargs='?', default=None, help='Layer used for dreaming.')

base_image_path = './j.png'
result_prefix = './q.png'
model = 'vgg16'
...
saved_settings = {
	'bad_trip'              : {
		'features'     : {
			'block4_conv1': 0.05, 'block4_conv2': 0.01, 'block4_conv3': 0.01
		}, 'continuity': 0.1, 'dream_l2': 0.8, 'jitter': 5
	}, 'dreamy'             : {
		'features'     : {
			'conv5_1': 0.05, 'conv5_2': 0.02
		}, 'continuity': 0.1, 'dream_l2': 0.02, 'jitter': 0
	}, 'vgg16_single_neuron': {
		'features': {'block5_conv1': 0.05, 'block3_conv1': 0.05}, 'continuity': 0.1, 'dream_l2': 1.0,
		'jitter': 1,
	},  # 21 textile, 26 eyes
	'resnet'                : {
		'features': {'bn4e_branch2b': 1.0}, 'continuity': 0.0, 'dream_l2': 0.0, 'jitter': 5, 'octave_count': 4, 'octave_scale': 1.2
	}
}

# the settings we will use in this experiment
settings = saved_settings['vgg16_single_neuron']
